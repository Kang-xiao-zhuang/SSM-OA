package com.zhuang.auth.controller;
...
import com.zhuang.vo.system.LoginVo;
...
/*        SysUser sysUser = sysUserService.getByUsername(loginVo.getUsername());
        ...
        if (sysUser.getStatus().intValue() == 0) {
            throw new KangException(201, "用户已经被禁用");
        }
